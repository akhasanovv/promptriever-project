...
\begin{table}[H]
    ...
    \begin{tabular}{lccccc}
        ...
        \midrule
        16 & 32 & 16 & 0.32\% & $68.015$ & $0.61896$ \\
        8 & 16 & 16 & 0.16\% & $61.392$ & $-0.09782$ \\
        \bottomrule
    \end{tabular}
    \vspace{0.2cm}
\end{table}
...
pMRR относительно baseline решения, причем получили 
сравнительно небольшую просадку в $-1.0$ по метрике nDCG@10. 
